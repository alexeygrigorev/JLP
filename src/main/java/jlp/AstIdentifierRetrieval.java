...
public class AstIdentifierRetrieval {

    public static final AstIdentifierRetrieval INSTANCE = new AstIdentifierRetrieval();
    ...
    public static void main(String[] args) throws Exception {
        ...
        ClassIdentifiers ids = AstIdentifierRetrieval.INSTANCE.read(path);
